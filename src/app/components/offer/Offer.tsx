...
const Offer = () => {
    return(
        <div className="font-metropolis mt-[75px]">
            <p className="text-center ml-auto mr-auto font-metropolis_700 text-[50px] w-[500px]">MAGNIFY <span className="text-[#ff5f5f]">YOUR</span> SUCCESS.</p>
            ...
            <div className="flex justify-center mt-[100px]">
                <div className="w-[600px] ml-[10px] m-[100px] mt-[100px]">
                    <p className="font-metropolis_700 text-[30px]">What we <span className="text-[#ff5f5f]">can offer you.</span></p>
                    <p>
                ...
                <div className="grid">
                    <div className="flex ml-[200px]">
                        <div className="w-[300px]">
                            <Image className="ml-[110px]" width={100} height={100} src={Camera} alt={"Camera"}/>
                            <p className="font-metropolis_700 text-center ml-[30px] text-[25px] mt-[20px]">VISIONARIES</p>
                        ...
                        <div className="w-[300px] ml-[150px] mt-[100px]">
                            <Image className="ml-[120px]" width={100} height={100} src={Heart} alt={"Heart"}/>
                            <p className="font-metropolis_700 text-center text-[25px] mt-[20px] ml-[40px]">ENGAGEMENT</p>
                            <p className="text-center w-[350px]">
                    ...
                    <div className="flex ml-[200px]">
                        <div className="w-[300px]">
                            <Image className="ml-[110px]" width={100} height={100} src={Time} alt={"Time"}/>
                            <p className="font-metropolis_700 text-center text-[25px] mt-[20px] ml-[30px]">YOUR TIME</p>
                            <p className="text-center w-[350px]">
                        ...
                        <div className="w-[300px] ml-[150px] mt-[50px]">
                            <Image className="ml-[110px]" width={100} height={100} src={Dollar} alt={"Dollar"}/>
                            <p className="font-metropolis_700 text-center text-[25px] mt-[20px] ml-[30px] w-[300px]">PAYROLL AND PRICING</p>
                            <p className="text-center w-[350px]">
                            ...
                            <p className="text-center w-[350px] mt-[15px]">
