    ...
    return(
        <div className="font-metropolis mt-[100px]">
            ...
            <form className="grid justify-center">
                <input className="w-[350px] h-[35px] rounded-2xl p-[5px] border-2 border-[#ff5f5f] max-[350px]:w-[250px]" type="email" placeholder="Your email here"/>
            ...
            <div className="mt-[100px]">
                <div className="flex justify-center min-[1300px]:mr-[920px] max-[1300px]:ml-auto">
                    <p className="font-metropolis_700 text-[35px] mt-[15px]">Latest Posts</p>
                    <Image className="m-[25px] max-[400px]:hidden" width={32} height={32} src={Left} alt="Left"/>
                    <Image className="m-[25px] max-[400px]:hidden" width={32} height={32} src={Right} alt="Right"/>
                </div>
                <div className="flex justify-center max-[1300px]:grid">
                    <div className="border-2 border-black w-[400px] rounded-xl m-[25px] max-[400px]:w-[300px] max-[400px]:ml-auto max-[400px]:mr-auto">
                        <div className="flex">
                        ...
                        <p className="w-[375px] m-[5px] max-[400px]:w-[250px]">
