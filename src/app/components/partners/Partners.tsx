const Partners = () => {
    return(
        <div className="mt-[100px] font-metropolis">
            <p className="text-center font-metropolis_900 text-[50px] mb-[50px]">NOTABLE PARTNERSHIPS</p>
            ...
            <div className="text-center mt-[25px]">
                ...
                <p className="text-[35px] w-[350px] ml-auto mr-auto">Interested in becoming a partner?</p>
